...
import src.constant.prediction_pipeline as prediction_pipeline
...
class DataIngestionConfig:
    ...
    training_file_path: str = os.path.join(ingested_data_dir, TRAIN_FILE_NAME)
    testing_file_path: str = os.path.join(ingested_data_dir, TEST_FILE_NAME)
